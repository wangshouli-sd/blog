...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-key"></span> 修改超管密码</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="index.php?m=admin&c=index&a=pass">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="password" class="input w50" id="mpassword" name="mpass" size="50" placeholder="请输入原始密码" data-validate="required:请输入原始密码" />       
        </div>
      </div>      
      <div class="form-group">
        <div class="label">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button class="button bg-main icon-check-square-o" name="tj" type="submit"> 提交</button>   
        </div>
      </div>      
    </form>
  </div>
