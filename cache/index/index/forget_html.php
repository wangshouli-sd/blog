...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="index.php?m=index&c=index&a=forget" method="post">
            <div class="panel loginbox">
                ...
                <div style="padding:30px;"><input type="submit" class="button button-block bg-main text-big input-big" name="tj" value="修改"></div>
            </div>
            </form>          
        </div>
    </div>
