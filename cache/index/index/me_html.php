...
<div class="wrap">
	<div class="header">
		...
		<div class="social-icons">
				...
				<a href="index.php?c=index&a=reset">忘记密码？</a>
		</div>
		<?php else: ?>
		<div class="social-icons">
		    <a href="index.php?c=index&a=index">随风首页</a>
...
<div class="wrap">
	<div class="main">
		...
		<?php foreach ($data_song as $key => $value): ?>
			<div class="blog_list">
				<h2><?=$value['title']; ?></h2>
				<h5><?php echo date('Y-m-d H:i:s',$value['time']);?>  <?=$value['label']; ?>
				<a href="#"><?=$value['singer']; ?></a></h5>
				<div class="blog_para">
					<p class="para"><a  href="index.php?c=index&a=details&tid=<?=$value['id']; ?>"><img src="<?=$value['icon']; ?>" width="320px" height="185px" alt=""/></a><?=$value['content']; ?></p>
					<div class="read_more">
						 <a class="btn" href="index.php?c=index&a=details&tid=<?=$value['id']; ?>">品味一刻</a>
					</div>
					<div class="clear"></div>
				</div>
			 </div>
